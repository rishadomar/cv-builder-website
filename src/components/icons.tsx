...
// To add new ones find in https://heroicons.com/ and copy the svg code
...
export const Icons = {
    ...
    arrow_down_on_square: (props: IconProps) => (
        <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
            viewBox='0 0 24 24'
    ...
    arrowRightStartOnRectangle: (props: IconProps) => (
        <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
            viewBox='0 0 24 24'
