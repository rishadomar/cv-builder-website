const PrivacyPage: React.FC = () => {
    return (
        <div>
            ...
            <p>
                Your privacy is important to us. It is Create Next App&apos;s policy to respect your privacy regarding
                any information we may collect from you across our website,{' '}
                <a href='https://create-next-app.com'>https://create-next-app.com</a>, and other sites we own and
                operate.
            </p>
            <p>
