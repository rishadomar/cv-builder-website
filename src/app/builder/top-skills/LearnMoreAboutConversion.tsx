...
export const LearnMoreAboutConversation = ({ title, countGenerations }: LearnMoreAboutConversationProps) => {
    ...
    const [startConversation, { isLoading: isGenerating }] = useStartTopSkillsConversationMutation();

    // Handle the generation start
    const handleStartGeneration = async () => {
        try {
            const result = await startConversation().unwrap();
            ...
            toast({
                variant: 'destructive',
                title: 'Error',
                description: 'Failed to start the conversation generation. Please try again.'
            });
        ...
        <>
            ...
            <Dialog open={showLearnMoreModal} onOpenChange={setShowLearnMoreModal}>
                <DialogContent className='px-4 max-w-[95%] sm:max-w-lg rounded-lg'>
                        ...
                        <>
                            <DialogDescription>
                                <div className='text-xs'>
                                    TopSkills are the skills that are most relevant to the job you are applying for.
                                    They are extracted from your work experience and are used to generate a conversation
                                    that you can use to prepare for interviews.
                                </div>
                                <div className='text-xs mt-2'>
                                    You can listen to the conversation to get a feel for how others feel about your
                                    skills. This can help you identify areas where you can improve and make your skills
                            ...
                            <div className='flex justify-end mt-4'>
                                <div className='max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 h-full'>
                                    ...
                                    <div className='text-xs my-3 text-center'>
                                        <strong>Note:</strong> The conversation is generated using AI and may not be
                                        100% accurate.
                                    </div>
                                </div>
                            </div>
                    ...
                    {showGenerator && !jobId && (
                        <div className='mt-2'>
                            <div className='text-xs text-center'>Requesting conversation generator...</div>
                        </div>
                    )}
                </DialogContent>
            </Dialog>
