    ...
    return (
        <div className='min-h-screen bg-gray-50'>
            ...
            <div className='container mx-auto px-4 py-12 lg:py-24 flex flex-col-reverse lg:flex-row items-center'>
                ...
                <div className='w-full lg:w-1/2 space-y-6 text-center lg:text-left'>
                    ...
                    <div className='flex justify-center lg:justify-start space-x-4'>
                        ...
                        >
                            Start Building Your CV <ArrowRight className='ml-2' />
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div className='bg-blue-600 text-white py-12 text-center'>
                ...
                <button
                    className='bg-white text-blue-600 px-6 md:px-8 py-3 md:py-4 rounded-lg hover:bg-gray-100 transition'
                    onClick={() => callToAction()}
                >
                    Get Started Now
                </button>
...
export default CVBuilderLandingPage;
